...
import '../../allApplicationsForAdmin/view/allApplicationsForAdmin.view.dart';
...
class AdminHomePageController extends GetxController {
  ...
  goToApprovedAppplications(){
    RoutesUtil.to(()=>DoneApplicationsView());
    // add an async-await function for fetching all those applications which have been approved
  }
}
